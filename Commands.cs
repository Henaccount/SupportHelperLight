...
[assembly: CommandClass(typeof(SupportsUtils.Commands))]
...
namespace SupportsUtils
{
    public class Commands
    {
        ...
        [CommandMethod("exposeParamsToSupportDetails", CommandFlags.UsePickSet)]
        public static void WriteChangeAblesTrue()
        {
            SupportsActions.WriteChangeAbles(true);
        }

        [CommandMethod("deleteSpecInfoFromSupports", CommandFlags.UsePickSet)]
